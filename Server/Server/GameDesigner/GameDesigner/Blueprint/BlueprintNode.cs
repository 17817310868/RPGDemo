...
namespace GameDesigner
{
	...
	public class BlueprintNode : MonoBehaviour
	{
		...
		public int stateID = 0;//状态ID
		public Property method = new Property();
		public BlueprintNode setValue = null;/// 入口方法,从这个方法类进入后自动遍历所有血脉
        ...
        /// Node name 自定义节点介绍名称
        /// </summary>
        static public BlueprintNode CreateFunctionBody( Blueprint designer , System.Type type , string funName , string inheritedName = "MonoBehaviour" , string nodeName = "函数入口" )
		{
