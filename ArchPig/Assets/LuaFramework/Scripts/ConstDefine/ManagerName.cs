...
namespace LuaFramework {
    public class ManagerName {
        ...
        public const string Scenes = "ScenesManager";
        public const string Client = "ClientManager";
        public const string LuaLoop = "LuaLooper";
        public const string Battle = "BattleMgr";
    }
}