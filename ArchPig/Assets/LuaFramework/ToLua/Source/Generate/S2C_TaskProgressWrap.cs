...
public class S2C_TaskProgressWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(S2C_TaskProgress), typeof(System.Object));
		L.RegFunction("New", _CreateS2C_TaskProgress);
	...
	static int _CreateS2C_TaskProgress(IntPtr L)
	{
		try
		{
			...
			if (count == 2)
			{
				...
				S2C_TaskProgress obj = new S2C_TaskProgress(arg0, arg1);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: S2C_TaskProgress.New");
			}
		}
		catch (Exception e)
		{
	...
	static int get_taskId(IntPtr L)
	{
		...
		try
		{
			...
			S2C_TaskProgress obj = (S2C_TaskProgress)o;
			int ret = obj.taskId;
