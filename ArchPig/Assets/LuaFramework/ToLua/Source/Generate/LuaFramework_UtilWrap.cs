...
public class LuaFramework_UtilWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetChildrens", GetChildrens);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetChildrens(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.Transform arg0 = (UnityEngine.Transform)ToLua.CheckObject<UnityEngine.Transform>(L, 1);
			UnityEngine.Transform[] o = LuaFramework.Util.GetChildrens(arg0);
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int ToggleAddListener(IntPtr L)
	{
		try
		{
			...
			LuaFramework.Util.ToggleAddListener(arg0, arg1);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int ToggleRemoveListener(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.UI.Toggle arg0 = (UnityEngine.UI.Toggle)ToLua.CheckObject<UnityEngine.UI.Toggle>(L, 1);
			LuaFramework.Util.ToggleRemoveListener(arg0);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int ShowPose(IntPtr L)
	{
		try
		{
			...
			System.Collections.IEnumerator o = LuaFramework.Util.ShowPose(arg0);
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
