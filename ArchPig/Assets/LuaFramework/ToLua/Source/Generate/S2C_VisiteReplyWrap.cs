...
public class S2C_VisiteReplyWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(S2C_VisiteReply), typeof(System.Object));
		L.RegFunction("New", _CreateS2C_VisiteReply);
	...
	static int _CreateS2C_VisiteReply(IntPtr L)
	{
		try
		{
			...
			if (count == 2)
			{
				...
				S2C_VisiteReply obj = new S2C_VisiteReply(arg0, arg1);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: S2C_VisiteReply.New");
			}
		}
		catch (Exception e)
		{
	...
	static int get_playerId(IntPtr L)
	{
		...
		try
		{
			...
			S2C_VisiteReply obj = (S2C_VisiteReply)o;
