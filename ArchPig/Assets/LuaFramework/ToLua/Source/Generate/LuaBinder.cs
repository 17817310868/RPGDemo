...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		buffWrap.Register(L);
		RankWrap.Register(L);
		RoleLevelRankWrap.Register(L);
		RolePowerRankWrap.Register(L);
		S2C_LoginOrRegisterCallbackWrap.Register(L);
		C2S_CreateMainRoleWrap.Register(L);
		S2C_OtherRoleInfoWrap.Register(L);
		C2S_CheckInfoWrap.Register(L);
		S2C_CheckInfoWrap.Register(L);
		S2C_SceneInfoWrap.Register(L);
		S2C_MainRoleInfoWrap.Register(L);
		S2C_MoveInfoWrap.Register(L);
		C2S_MoveInfoWrap.Register(L);
		S2C_AddItemsInfoWrap.Register(L);
		S2C_AddItemInfoWrap.Register(L);
		C2S_BuyItemWrap.Register(L);
		S2C_ReduceItemWrap.Register(L);
		S2C_ReduceItemsWrap.Register(L);
		S2C_AddEquipInfoWrap.Register(L);
		S2C_AddEquipsInfoWrap.Register(L);
		C2S_UseItemWrap.Register(L);
		C2S_DressEquipWrap.Register(L);
		S2C_DressEquipWrap.Register(L);
		C2S_TakeoffEquipWrap.Register(L);
		S2C_TakeoffEquipWrap.Register(L);
		C2S_DiscardItemWrap.Register(L);
		C2S_MakeEquipWrap.Register(L);
		C2S_AdvanceEquipWrap.Register(L);
		C2S_InlayGemWrap.Register(L);
		C2S_RemoveGemWrap.Register(L);
		S2C_RemoveItemInfoWrap.Register(L);
		S2C_RemoveItemsWrap.Register(L);
		S2C_UpdateItemInfoWrap.Register(L);
		S2C_UpdateLeaderWrap.Register(L);
		S2C_AddSkillWrap.Register(L);
		S2C_AddSkillsWrap.Register(L);
		S2C_RemoveSkillWrap.Register(L);
		S2C_UpdateSkillWrap.Register(L);
		C2S_UpgradeSkillWrap.Register(L);
		C2S_LearnSkillWrap.Register(L);
		S2C_TeamInfoWrap.Register(L);
		C2S_JoinTeamRequestWrap.Register(L);
		S2C_JoinTeamRequestWrap.Register(L);
		C2S_JoinTeamReplyWrap.Register(L);
		S2C_JoinTeamReplyWrap.Register(L);
		C2S_VisiteRequestWrap.Register(L);
		S2C_VisiteRequestWrap.Register(L);
		C2S_VisiteReplyWrap.Register(L);
		S2C_VisiteReplyWrap.Register(L);
		C2S_BattleRequestWrap.Register(L);
		S2C_BattleRequestWrap.Register(L);
		C2S_BattleReplyWrap.Register(L);
		S2C_BattleReplyWrap.Register(L);
		C2S_BattleCommandWrap.Register(L);
		S2C_RoundWrap.Register(L);
		S2C_BattlerInfoWrap.Register(L);
		S2C_InitBattlersWrap.Register(L);
		S2C_UpdateBattleWrap.Register(L);
		S2C_UpdateBattlesWrap.Register(L);
		S2C_AcceptableTasksWrap.Register(L);
		S2C_ConductTasksWrap.Register(L);
		S2C_AllTaskInfoWrap.Register(L);
		S2C_TaskProgressWrap.Register(L);
		S2C_AcceptTaskWrap.Register(L);
		C2S_AcceptTaskWrap.Register(L);
		C2S_CompleteTaskWrap.Register(L);
		S2C_CompleteTaskWrap.Register(L);
		C2S_CheckRankWrap.Register(L);
		S2C_RoleLevelRankWrap.Register(L);
		S2C_RolePowerRankWrap.Register(L);
		C2S_SendMailWrap.Register(L);
		S2C_ReceiveMailWrap.Register(L);
		S2C_ReceiveMailsWrap.Register(L);
		C2S_GetMailItemsWrap.Register(L);
		C2S_ReadMailWrap.Register(L);
		C2S_AuctionWrap.Register(L);
		C2S_BiddingWrap.Register(L);
		C2S_FixedBuyWrap.Register(L);
		C2S_GetLotsWrap.Register(L);
		C2S_SearchLotsWrap.Register(L);
		S2C_LotsInfoWrap.Register(L);
		S2C_LotsInfosWrap.Register(L);
		RoleCtrlWrap.Register(L);
		RoleMgrWrap.Register(L);
		NPCManagerWrap.Register(L);
		BattleMgrWrap.Register(L);
		CameraMgrWrap.Register(L);
		ClientManagerWrap.Register(L);
		EventManagerWrap.Register(L);
		ScenesManagerWrap.Register(L);
		StateMgrWrap.Register(L);
		...
		LuaFramework_GameObjectPoolWrap.Register(L);
		L.EndModule();
		L.BeginModule("Net");
		L.BeginModule("Client");
		Net_Client_NetBehaviourWrap.Register(L);
		L.EndModule();
		L.BeginModule("Share");
		Net_Share_RpcWrap.Register(L);
		Net_Share_RPCFunWrap.Register(L);
		L.EndModule();
		L.EndModule();
