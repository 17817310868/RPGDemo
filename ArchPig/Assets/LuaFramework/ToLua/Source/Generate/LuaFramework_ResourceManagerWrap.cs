...
public class LuaFramework_ResourceManagerWrap
{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int LoadAssetSprite(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			else if (count == 4)
			{
				...
				obj.LoadAssetSprite(arg0, arg1, arg2);
				return 0;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: LuaFramework.ResourceManager.LoadAssetSprite");
			}
		}
		catch (Exception e)
		{
